...
urlpatterns = [
    ...
    path('bank-staff/users/<int:user_id>/', views.manage_user_detail, name='manage_user_detail'),
    path('bank-staff/users/<int:user_id>/freeze/', views.toggle_freeze_account, name='toggle_freeze'),
    path('bank-staff/users/<int:user_id>/reset-password/', views.admin_reset_password, name='admin_reset_password'),
    
    # ✅ FIXED: Account Types Management - CORRECT URL NAME
    path('bank-staff/account-types/', views.manage_account_types, name='manage_account_types'),
    path('bank-staff/account-types/add/', views.add_account_type, name='add_account_type'),
    path('bank-staff/account-types/<int:pk>/edit/', views.edit_account_type, name='edit_account_type'),
    path('bank-staff/account-types/<int:pk>/delete/', views.delete_account_type, name='delete_account_type'),
    
    # ✅ Transaction Management
    path('bank-staff/transactions/', views.manage_transactions, name='manage_transactions'),
    path('bank-staff/transactions/<int:transaction_id>/rollback/', views.rollback_transaction, name='rollback_transaction'),
    path('bank-staff/transactions/<int:transaction_id>/edit/', views.edit_transaction, name='edit_transaction'),
    path('bank-staff/transactions/<int:transaction_id>/delete/', views.delete_transaction, name='delete_transaction'),
